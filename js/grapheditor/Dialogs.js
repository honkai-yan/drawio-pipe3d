...
var EditDiagramDialog = function(editorUi)
{
	...
	var preview3dBtn = mxUtils.button('3d预览', function()
	{
		editorUi.hideDialog();
		...
		var xmlData = mxUtils.getXml(editorUi.editor.getGraphXml());

		var iframe = document.createElement('iframe');
		iframe.src = '3d-dist/index.html';
		iframe.style.cssText = 'width:100%;height:100%;border:none;';
		iframe.onload = function()
		{
			var target = iframe.contentDocument.getElementById('mxgraph-xml-source');

			if (target)
			{
				target.textContent = xmlData;
			}
		};
		...
		closeBtn.style.cssText = 'position:absolute;left:16px;bottom:16px;z-index:1;padding:8px 18px;font-size:14px;cursor:pointer;border:none;border-radius:4px;background:#fff;color:#333;box-shadow:0 2px 8px rgba(0,0,0,0.3);';
	...
	preview3dBtn.className = 'geBtn';
	buttons.appendChild(preview3dBtn);
	console.info(`Hook: created preview 3d button in edit diagram dialog`)
